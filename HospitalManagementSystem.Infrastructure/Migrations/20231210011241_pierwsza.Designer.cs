...
namespace HospitalManagementSystem.Infrastructure.Migrations
{
    ...
    [Migration("20231210011241_pierwsza")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HospitalManagementSystem.Domain.Models.Dept.Department", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("7f23eef5-9198-4169-b29b-e7a7ca968fb8"),
                            Name = "Childcare"
                        },
                        new
                        {
                            Id = new Guid("8cadd26f-d13b-4c1e-85b1-e97fc935112d"),
                            Name = "Dentistry"
                        });
                });

            modelBuilder.Entity("HospitalManagementSystem.Domain.Models.Dept.Room", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("HospitalManagementSystem.Domain.Models.Dept.Room+Key", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("HospitalManagementSystem.Domain.Models.Dept.Visit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("HospitalManagementSystem.Domain.Models.Dept.Room", b =>
                {
                    b.HasOne("HospitalManagementSystem.Domain.Models.Dept.Department", "Department")
                        .WithMany("Rooms")
            ...
            modelBuilder.Entity("HospitalManagementSystem.Domain.Models.Dept.Room+Key", b =>
                {
                    ...
                    b.HasOne("HospitalManagementSystem.Domain.Models.Dept.Room", "Room")
                        .WithMany("Keys")
            ...
            modelBuilder.Entity("HospitalManagementSystem.Domain.Models.Dept.Visit", b =>
                {
                    b.HasOne("HospitalManagementSystem.Domain.Models.Payments.Bill", "Bill")
                        .WithOne("Visit")
                        .HasForeignKey("HospitalManagementSystem.Domain.Models.Dept.Visit", "BillId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
